...
user="wulff"
company="wulff"}
C {devices/ipin.sym} -260 -410 0 0 {name=p1 lab=VSS \{xschem version=3.4.4 file_version=1.2
*
...
VSS}
C {devices/ipin.sym} -260 -530 0 0 {name=p2 lab=IBPS_5U \{xschem version=3.4.4 file_version=1.2
*
* This file is part of XSCHEM,
* a schematic capture and Spice/Vhdl/Verilog netlisting tool for circuit
* simulation.
